        ...
        <button
          ...
          className={classNames(
            ...
            tab.id === activeTab
              ...
              : classNames(
                  'bg-aisso-elements-background-depth-2 dark:bg-aisso-elements-background-depth-3 text-aisso-elements-textPrimary dark:text-aisso-elements-textPrimary-dark hover:bg-aisso-elements-background-depth-3 dark:hover:bg-aisso-elements-background-depth-4 border border-aisso-elements-borderColor dark:border-aisso-elements-borderColor-dark',
                  tabClassName,
                ),
          )}
        >
