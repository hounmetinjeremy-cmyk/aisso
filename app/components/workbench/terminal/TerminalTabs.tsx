  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-aisso-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-aisso-elements-background-depth-2 border-y border-aisso-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-aisso-elements-terminals-buttonBackground text-aisso-elements-textSecondary hover:text-aisso-elements-textPrimary':
                            isActive,
                          'bg-aisso-elements-background-depth-2 text-aisso-elements-textSecondary hover:bg-aisso-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-aisso-elements-terminals-buttonBackground text-aisso-elements-textPrimary': isActive,
                            'bg-aisso-elements-background-depth-2 text-aisso-elements-textSecondary hover:bg-aisso-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-aisso-elements-textTertiary hover:text-aisso-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachAissoTerminal(terminal);
                  } else {
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachAissoTerminal(terminal)}
