    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4 mb-6">
        <Button
          ...
          size="sm"
          onClick={onBack}
          className="bg-transparent hover:bg-transparent text-aisso-elements-textSecondary hover:text-aisso-elements-textPrimary transition-all duration-200 p-2"
          aria-label="Back to Dashboard"
        >
          <ArrowLeft className="w-4 h-4" />
        </Button>
        <div>
          <h2 className="text-xl font-semibold text-aisso-elements-textPrimary">Local Provider Setup Guide</h2>
      ...
      <Card className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 shadow-sm">
        <CardContent className="p-6">
          <div className="flex items-center gap-3 mb-4">
            ...
            <div>
              <h3 className="text-lg font-semibold text-aisso-elements-textPrimary">System Requirements</h3>
              <p className="text-sm text-aisso-elements-textSecondary">Recommended hardware for optimal performance</p>
            </div>
          </div>
          <div className="grid md:grid-cols-3 gap-4 text-sm">
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                ...
                <span className="font-medium text-aisso-elements-textPrimary">CPU</span>
              </div>
              <p className="text-aisso-elements-textSecondary">8+ cores, modern architecture</p>
            </div>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <Database className="w-4 h-4 text-blue-500" />
                <span className="font-medium text-aisso-elements-textPrimary">RAM</span>
              </div>
              <p className="text-aisso-elements-textSecondary">16GB minimum, 32GB+ recommended</p>
            </div>
            <div className="space-y-2">
              <div className="flex items-center gap-2">
                <Monitor className="w-4 h-4 text-purple-500" />
                <span className="font-medium text-aisso-elements-textPrimary">GPU</span>
              </div>
              <p className="text-aisso-elements-textSecondary">NVIDIA RTX 30xx+ or AMD RX 6000+</p>
            </div>
          </div>
        </CardContent>
      </Card>
      ...
      <Card className="bg-aisso-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-semibold text-aisso-elements-textPrimary">Ollama Setup</h3>
              <p className="text-sm text-aisso-elements-textSecondary">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            <h4 className="font-medium text-aisso-elements-textPrimary flex items-center gap-2">
            ...
            <div className="p-4 rounded-lg bg-green-500/5 border border-green-500/20">
              ...
              <p className="text-sm text-aisso-elements-textSecondary mb-3">
                New user-friendly desktop application with built-in model management and web interface.
              </p>
              <div className="grid md:grid-cols-2 gap-4">
                <div className="p-3 rounded-lg bg-aisso-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-2">
                    <Monitor className="w-4 h-4 text-aisso-elements-textPrimary" />
                    <strong className="text-aisso-elements-textPrimary">macOS</strong>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
                ...
                <div className="p-3 rounded-lg bg-aisso-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-2">
                    <Monitor className="w-4 h-4 text-aisso-elements-textPrimary" />
                    <strong className="text-aisso-elements-textPrimary">Windows</strong>
                  </div>
                  <Button
                    variant="outline"
                    size="sm"
              ...
              <div className="mt-3 p-3 rounded-lg bg-blue-500/5 border border-blue-500/20">
                ...
                <p className="text-xs text-aisso-elements-textSecondary">
                  Desktop app includes a web interface at{' '}
                  <code className="bg-aisso-elements-background-depth-4 px-1 rounded">http://localhost:11434</code>
                </p>
              </div>
            </div>

            {/* CLI Installation */}
            <div className="p-4 rounded-lg bg-aisso-elements-background-depth-3">
              <div className="flex items-center gap-2 mb-3">
                <Terminal className="w-5 h-5 text-aisso-elements-textPrimary" />
                <h5 className="font-medium text-aisso-elements-textPrimary">Command Line (Advanced)</h5>
              </div>
              <div className="grid md:grid-cols-3 gap-4">
                <div className="p-3 rounded-lg bg-aisso-elements-background-depth-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Monitor className="w-4 h-4 text-aisso-elements-textPrimary" />
                    <strong className="text-aisso-elements-textPrimary">Windows</strong>
                  </div>
                  <div className="text-xs bg-aisso-elements-background-depth-4 p-2 rounded font-mono text-aisso-elements-textPrimary">
                ...
                <div className="p-3 rounded-lg bg-aisso-elements-background-depth-4">
                  <div className="flex items-center gap-2 mb-2">
                    <Terminal className="w-4 h-4 text-aisso-elements-textPrimary" />
                    <strong className="text-aisso-elements-textPrimary">Linux</strong>
                  </div>
                  <div className="text-xs bg-aisso-elements-background-depth-4 p-2 rounded font-mono text-aisso-elements-textPrimary">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-aisso-elements-background-depth-3">
                <h5 className="font-medium text-aisso-elements-textPrimary mb-3 flex items-center gap-2">
                  <Code className="w-4 h-4 text-green-500" />
                  Code & Development
                </h5>
                <div className="space-y-2 text-xs bg-aisso-elements-background-depth-4 p-3 rounded font-mono text-aisso-elements-textPrimary">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-purple-500/5 border border-purple-500/20">
                ...
                <ul className="text-xs text-aisso-elements-textSecondary space-y-1">
            ...
            <div className="p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  <ul className="text-sm text-aisso-elements-textSecondary space-y-1">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              <div className="p-4 rounded-lg bg-green-500/5 border border-green-500/20">
                ...
                <div className="text-xs bg-aisso-elements-background-depth-4 p-3 rounded font-mono text-aisso-elements-textPrimary space-y-1">
      ...
      <Card className="bg-aisso-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-semibold text-aisso-elements-textPrimary">LM Studio Setup</h3>
              <p className="text-sm text-aisso-elements-textSecondary">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="p-4 rounded-lg bg-aisso-elements-background-depth-3">
                <h5 className="font-medium text-aisso-elements-textPrimary mb-2">Start Local Server</h5>
                <ol className="text-xs text-aisso-elements-textSecondary space-y-1 list-decimal list-inside">
              ...
              <div className="p-4 rounded-lg bg-red-500/10 border border-red-500/20">
                ...
                <div className="space-y-2">
                  <p className="text-xs text-aisso-elements-textSecondary">
                    To work with Aïsso, you MUST enable CORS in LM Studio:
                  </p>
                  <ol className="text-xs text-aisso-elements-textSecondary space-y-1 list-decimal list-inside ml-2">
                    <li>In Server Settings, check "Enable CORS"</li>
                    <li>Set Network Interface to "0.0.0.0" for external access</li>
                    <li>
                      Alternatively, use CLI:{' '}
                      <code className="bg-aisso-elements-background-depth-4 px-1 rounded">lms server start --cors</code>
                    </li>
                  </ol>
                </div>
              </div>
          ...
          <div className="p-4 rounded-lg bg-blue-500/10 border border-blue-500/20">
            ...
            <ul className="text-xs text-aisso-elements-textSecondary space-y-1 list-disc list-inside">
      ...
      <Card className="bg-aisso-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-semibold text-aisso-elements-textPrimary">LocalAI Setup</h3>
              <p className="text-sm text-aisso-elements-textSecondary">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              <div className="p-4 rounded-lg bg-aisso-elements-background-depth-3">
                <h5 className="font-medium text-aisso-elements-textPrimary mb-2">Quick Install</h5>
                <div className="text-xs bg-aisso-elements-background-depth-4 p-3 rounded font-mono text-aisso-elements-textPrimary space-y-1">
              ...
              <div className="p-4 rounded-lg bg-aisso-elements-background-depth-3">
                <h5 className="font-medium text-aisso-elements-textPrimary mb-2">Docker (Recommended)</h5>
                <div className="text-xs bg-aisso-elements-background-depth-4 p-3 rounded font-mono text-aisso-elements-textPrimary space-y-1">
      ...
      <Card className="bg-gradient-to-r from-purple-500/10 to-pink-500/10 border border-purple-500/20 shadow-sm">
        <CardHeader className="pb-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="text-lg font-semibold text-aisso-elements-textPrimary">Performance Optimization</h3>
              <p className="text-sm text-aisso-elements-textSecondary">Tips to improve local AI performance</p>
            </div>
          </div>
        </CardHeader>
        <CardContent className="space-y-4">
          <div className="grid md:grid-cols-2 gap-4">
            <div className="space-y-3">
              <h4 className="font-medium text-aisso-elements-textPrimary">Hardware Optimizations</h4>
              <ul className="text-sm text-aisso-elements-textSecondary space-y-2">
            ...
            <div className="space-y-3">
              <h4 className="font-medium text-aisso-elements-textPrimary">Software Optimizations</h4>
              <ul className="text-sm text-aisso-elements-textSecondary space-y-2">
                <li className="flex items-start gap-2">
      ...
      <Card className="bg-aisso-elements-background-depth-2 shadow-sm">
        <CardHeader className="pb-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h3 className="text-xl font-semibold text-aisso-elements-textPrimary">Alternative Options</h3>
              <p className="text-sm text-aisso-elements-textSecondary">
        ...
        <CardContent className="space-y-6">
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <h4 className="font-medium text-aisso-elements-textPrimary">Other Local Solutions</h4>
              <div className="space-y-3">
                <div className="p-3 rounded-lg bg-aisso-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    <Package className="w-4 h-4 text-blue-500" />
                    <span className="font-medium text-aisso-elements-textPrimary">Jan.ai</span>
                  </div>
                  <p className="text-xs text-aisso-elements-textSecondary">
                ...
                <div className="p-3 rounded-lg bg-aisso-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-medium text-aisso-elements-textPrimary">Oobabooga</span>
                  </div>
                  <p className="text-xs text-aisso-elements-textSecondary">
                ...
                <div className="p-3 rounded-lg bg-aisso-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <span className="font-medium text-aisso-elements-textPrimary">KoboldAI</span>
                  </div>
                  <p className="text-xs text-aisso-elements-textSecondary">Focus on creative writing and storytelling</p>
                </div>
              </div>
            </div>
            <div className="space-y-4">
              <h4 className="font-medium text-aisso-elements-textPrimary">Cloud Alternatives</h4>
              <div className="space-y-3">
                <div className="p-3 rounded-lg bg-aisso-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    <Globe className="w-4 h-4 text-orange-500" />
                    <span className="font-medium text-aisso-elements-textPrimary">OpenRouter</span>
                  </div>
                  <p className="text-xs text-aisso-elements-textSecondary">Access to 100+ models through unified API</p>
                </div>
                <div className="p-3 rounded-lg bg-aisso-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    <Server className="w-4 h-4 text-red-500" />
                    <span className="font-medium text-aisso-elements-textPrimary">Together AI</span>
                  </div>
                  <p className="text-xs text-aisso-elements-textSecondary">Fast inference with open-source models</p>
                </div>
                <div className="p-3 rounded-lg bg-aisso-elements-background-depth-3">
                  <div className="flex items-center gap-2 mb-1">
                    <Activity className="w-4 h-4 text-pink-500" />
                    <span className="font-medium text-aisso-elements-textPrimary">Groq</span>
                  </div>
                  <p className="text-xs text-aisso-elements-textSecondary">Ultra-fast LPU inference for Llama models</p>
                </div>
              </div>
            </div>
          </div>
