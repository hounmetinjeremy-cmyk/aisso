    ...
    <div className="space-y-4">
      ...
      <div className="relative">
        <input
          ...
          className="w-full px-4 py-2 pl-10 rounded-lg bg-aisso-elements-background-depth-2 border border-aisso-elements-borderColor text-aisso-elements-textPrimary placeholder-aisso-elements-textTertiary focus:outline-none focus:ring-1 focus:ring-aisso-elements-borderColorActive"
        />
        <div className="absolute left-3 top-1/2 -translate-y-1/2">
          {isSearching ? (
            <div className="i-ph:spinner animate-spin w-4 h-4 text-aisso-elements-textSecondary" />
          ) : (
            <div className="i-ph:magnifying-glass w-4 h-4 text-aisso-elements-textSecondary" />
          )}
        </div>
      </div>
      ...
      <div className="space-y-4">
        {filteredRepositories.length === 0 ? (
          <div className="text-center py-8 text-aisso-elements-textSecondary">
