...
export function WebSearch({ onSearchResult, disabled = false }: WebSearchProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        {isSearching ? (
          <div className="i-svg-spinners:90-ring-with-bg text-aisso-elements-loader-progress text-xl animate-spin" />
        ) : (
      ...
      {isOpen && (
        <div
          className={classNames(
            ...
            'rounded-lg border border-aisso-elements-borderColor bg-aisso-elements-background-depth-2 p-2 shadow-lg',
          )}
        >
          <input
            ref={inputRef}
            ...
            className={classNames(
              ...
              'bg-aisso-elements-background-depth-1 text-aisso-elements-textPrimary',
              'placeholder-aisso-elements-textTertiary',
          ...
          <button
            ...
            className={classNames(
              ...
              'bg-aisso-elements-button-primary-background text-aisso-elements-button-primary-text',
