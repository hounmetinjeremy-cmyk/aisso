      ...
      >
        <div
          className={classNames(
            ...
            'p-1 rounded-lg text-aisso-elements-item-contentAccent',
            'flex ',
          )}
        >
          ...
          <motion.button
            ...
            className=" p-1 rounded-lg bg-aisso-elements-item-backgroundAccent hover:bg-aisso-elements-artifacts-backgroundHover"
