      ...
      return {
        div: ({ className, children, node, ...props }) => {
          ...
          if (className?.includes('__boltSelectedElement__')) {
            ...
            return (
              <div className="bg-aisso-elements-background-depth-3 border border-aisso-elements-borderColor rounded-lg p-3 my-2">
                <div className="flex items-center gap-2 mb-2">
                  <span className="text-xs font-mono bg-aisso-elements-background-depth-2 px-2 py-1 rounded text-aisso-elements-textTer">
                    {elementData?.tagName}
                  </span>
                  {elementData?.className && (
                    <span className="text-xs text-aisso-elements-textSecondary">.{elementData.className}</span>
                  )}
                </div>
                <code className="block text-sm !text-aisso-elements-textSecondary !bg-aisso-elements-background-depth-2 border border-aisso-elements-borderColor p-2 rounded">
          ...
          if (className?.includes('__boltQuickAction__') || dataProps?.dataAïssoQuickAction) {
        ...
        button: ({ node, children, ...props }) => {
          ...
          if (
            ...
            dataProps?.dataAïssoQuickAction === 'true'
          ) {
            ...
            return (
              <button
                className="rounded-md justify-center px-3 py-1.5 text-xs bg-aisso-elements-item-backgroundAccent text-aisso-elements-item-contentAccent opacity-90 hover:opacity-100 flex items-center gap-2 cursor-pointer"
                data-type={type}
