 ...
 *
 * Nécessaire pour que la sauvegarde des snapshots de projet (code source
 * complet) sur Supabase soit rattachée à un utilisateur *vérifié* — et non
 * simplement déclaré par le client — avant d'écrire quoi que ce soit avec
 * la clé Supabase service_role (qui contourne toutes les policies RLS).
 */
