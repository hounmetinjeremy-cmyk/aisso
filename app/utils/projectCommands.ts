...
export function escapeAissoArtifactTags(input: string) {
...
export function escapeAissoAActionTags(input: string) {
  // Regular expression to match boltArtifact tags and their content
...
export function escapeAissoTags(input: string) {
  return escapeAissoArtifactTags(escapeAissoAActionTags(input));
}
