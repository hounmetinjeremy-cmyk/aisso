#!/bin/bash
# ⚠️ OBSOLÈTE depuis la migration Worker pur : utilisez .dev.vars (voir .dev.vars.example).
# Ce script ne sert plus a wrangler dev / remix vite:dev (qui lisent .dev.vars nativement).
# Conservé pour compatibilité avec un éventuel usage Docker historique.
